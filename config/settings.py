...
STRIPE_APPLICATION_FEE_PERCENT = os.environ.get("STRIPE_APPLICATION_FEE_PERCENT", "0")
STRIPE_APPLICATION_FEE_FIXED_CENTS = os.environ.get("STRIPE_APPLICATION_FEE_FIXED_CENTS", "0")
